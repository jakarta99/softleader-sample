...
public class SPersonServiceTest {
	...
	public void testInsertAndUpdateAndDelete() {
		...
		log.debug("insert person Id:" + insperson.getId());
		...
		log.debug("insert person sportname getonechk:" + Spersonchk.getSports().iterator().next().getName());
		...
		log.debug("update person :" + insperson);
